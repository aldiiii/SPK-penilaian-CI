...
<div class="container-fluid">
	<div class="panel">
		<div class="panel-heading">
			<h2 class="panel-title">Tambah Task</h2>
		</div>
		<div class="panel-body">
			<form class="form-horizontal" action="<?php echo site_url('systask/add'); ?>" method="POST" id="addForm">
				<div class="form-group">
			  	...
			  	<div class="form-group">
				    ...
				    <div class="col-sm-6">
				      	<input type="text" class="form-control" name="task" id="task" placeholder="Masukan task">
				    </div>
			  	</div>
			  	<div class="form-group">
