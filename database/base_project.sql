...
CREATE TABLE `spk_sys_user` (
  ...
  `user_type` enum('1','2') COLLATE latin1_general_ci NOT NULL DEFAULT '1' COMMENT '1 = Biasa, 2 Borongan',
  PRIMARY KEY (`user_id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `spk_sys_user` VALUES (4, 'Super Admin', 'superadmin@email.com', '022', 'Bandung', 1, 'superadmin', '83626cc96878b9d30721cd4fb0baee63', 1, '2019-09-18 23:31:53', 1, NULL, '1');
COMMIT;
