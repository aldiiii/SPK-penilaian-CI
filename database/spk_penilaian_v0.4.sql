...
INSERT INTO `spk_detail_kriteria` VALUES (5, 2, 'Data Detail', '2019-09-25 21:15:43', '2019-09-25 21:15:43');
INSERT INTO `spk_detail_kriteria` VALUES (6, 2, 'Inget', '2019-09-25 21:34:38', '2019-09-25 21:34:38');
INSERT INTO `spk_detail_kriteria` VALUES (7, 5, 'Diri', '2019-09-25 21:35:12', '2019-09-25 21:35:12');
INSERT INTO `spk_detail_kriteria` VALUES (8, 5, 'Iman', '2019-09-25 21:35:18', '2019-09-25 21:35:18');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `spk_penilaian` VALUES (51, 2, 4, 7, 4, 2.5, '2019-09-25', '2019-09-25');
INSERT INTO `spk_penilaian` VALUES (52, 2, 4, 7, 2, 3.5, '2019-09-25', '2019-09-25');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `spk_penilaian_respon` VALUES (36, 51, 4, 1, 4, '2019-09-25', '2019-09-25');
INSERT INTO `spk_penilaian_respon` VALUES (37, 51, 4, 4, 1, '2019-09-25', '2019-09-25');
INSERT INTO `spk_penilaian_respon` VALUES (38, 52, 2, 5, 3, '2019-09-25', '2019-09-25');
INSERT INTO `spk_penilaian_respon` VALUES (39, 52, 2, 6, 4, '2019-09-25', '2019-09-25');
COMMIT;
...
INSERT INTO `spk_sys_user` VALUES (7, 'Indar', 'indra@mail.com', '0981293819', 'Bandung Coret', 3, '', '575cd789df8f886cb92b92f174a20283', '1', '0000-00-00 00:00:00', 0, NULL, 'islam', '2019-09-25', '2019-09-25', 'NIK002');
COMMIT;
...
CREATE VIEW `spk_v_penilaian` AS select `spk_penilaian`.`penilaian_id` AS `penilaian_id`,`spk_penilaian`.`periode_id` AS `periode_id`,`spk_penilaian`.`user_id` AS `user_id`,`spk_penilaian`.`target_user_id` AS `target_user_id`,`spk_penilaian`.`kriteria_id` AS `kriteria_id`,`spk_penilaian`.`score` AS `score`,`spk_penilaian`.`created_at` AS `created_at`,`spk_penilaian`.`updated_at` AS `updated_at`,`spk_sys_user`.`user_name` AS `user_name`,`spk_sys_user_alias1`.`user_name` AS `target_user_name` from ((`spk_penilaian` join `spk_sys_user` on((`spk_penilaian`.`user_id` = `spk_sys_user`.`user_id`))) join `spk_sys_user` `spk_sys_user_alias1` on((`spk_penilaian`.`target_user_id` = `spk_sys_user_alias1`.`user_id`)));
